            ...
            <div class="row">
                <div class="col-lg-6">
                  ...
                  <dt>Geslacht</dt><dd><select name="GENDER" type="text" class="form-control" required>
                   ...
                   <dt>Soort</dt><dd><input name="LATINNAME"  type="hidden" value="'.$_GET['headspecies'].'" required>'.$_GET['headspecies'];

            echo '</dd><br>
                   <dt>Sub soort</dt><dd><input name="SUBSPECIESNAME" type="hidden" value="'.$_GET['subspecies'].'" class="form-control" required>'.$_GET['subspecies'];
            echo '<br><br><dt>Moeder </dt><dd><select name="MOTHER" type="text" class="form-control" required>';
            foreach ($getMothers as $mother) {
                echo '<option value="' . $mother['AnimalID'] . '">' . $mother['AnimalName'] . '</option>';
            }
            echo '<option selected="" value="">niet bekend</option>
                    </select></dd><br>
                    <dt>Vader </dt><dd><select name="FATHER" type="text" class="form-control" required>';
