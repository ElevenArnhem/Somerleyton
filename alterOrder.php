<?php
    ...
    <form action="index.php?page=alterOrder" method="post">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <?php if(isset( $orderDetails[0]['OrderReceivedDate'])) { ?>
                            <input type="hidden" name="OrderRecievedDate" value="<?php echo $orderDetails[0]['OrderReceivedDate'] ?>" />
                        <?php }
                        ...
                        if(isset( $orderDetails[0]['InvoicePaidDate'])) {?>
                            <input type="hidden" name="InvoicePaidDate" value="<?php echo $orderDetails[0]['InvoicePaidDate'] ?>" />
                        <?php } ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h4>Opmerkingen</h4>
                <textarea name="OrderComments" class="form-control" rows="5" maxlength="250"><?php echo $orderDetails[0]['Comment'] ?></textarea>
            </div>
        </div>
