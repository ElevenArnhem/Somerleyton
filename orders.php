    ...
    <form action="index.php?page=orders" method="post">
        <div class="input-group">
            <input name="SearchCriteria" type="text" class="form-control"
                   placeholder="Zoeken op ordernummer, datum of medewerker">
        ...
        <select name="OrderStatus" type="text" class="form-control" value="<?php echo $currentOrderStatus ?>">
            ...
            foreach ($orderStates as $orderState) {
                ?>
                <option
                    value="<?php echo $orderState['OrderState'] ?>" <?php if ($orderState['OrderState'] == $currentOrderStatus) {
                    echo 'selected';
                } ?>><?php echo $orderState['OrderState'] ?></option>
            <?php
            }
            ?>
        </select>
    ...
    <table class="table table-hover">
        ...
        foreach ($orders as $order) {
            ...
            <tr>
                ...
                <td><?php $date = new DateTime($order['OrderDate']);
