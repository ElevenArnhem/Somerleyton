<?php
    if(canRead() && canUpdate()) {
        ...
        <br>
            <div class="row">
                <div class="col-lg-6">
                  <h2>Dier Info</h2>
                    <form action="index.php?page=changeAnimal&animalID='.$animal['AnimalID'].'" method="post" enctype="multipart/form-data">
                        ...
                        <dt>Naam</dt>
                        <dd>
                            <input name="ANIMALNAME" type="text" class="form-control" value="'.$animal['AnimalName'].'" maxlength="50">
                            </dd>
                        <br>
                        <dt>Geslacht</dt>
                        <dd>
                            <select name="GENDER" type="text" class="form-control" value="'.$animal['Gender'].'">
                                <option value="F">Vrouwtje</option>
                                <option value="M"';if($animal['Gender'] == "M"){ echo'selected'; } echo'>Mannetje </option>
                                <option value="U" ';if($animal['Gender'] == "U"){ echo'selected'; } echo'>Nog niet bekend</option>
                            </select>
                        </dd>
                        <br>
                   <dt>Soort</dt>
                   <dd>
                        <select name="LATINNAME" type="text" class="form-control" value="'.$animal['LatinName'].'">
                            <option value="'.$animal['LatinName'].'">'.$animal['LatinName'].'</option>';
               ...
               echo'    </select>
                    ...
                    <dt>Sub soort</dt>
                    <dd>
                        <select name="SUBSPECIESNAME" type="text" class="form-control" value="'.$animal['SubSpeciesName'].'">
                            <option value="'.$animal['SubSpeciesName'].'">'.$animal['SubSpeciesName'].'</option>';
            ...
            echo'        </select>
                    ...
                    <dd>
                        <input name="BIRTHPLACE" type="text" class="form-control" value="'.$animal['BirthPlace'].'" maxlength="50">
                    </dd>
                    <br>
                    <dt>Geboorte datum</dt>
                    <dd>
                        <input name="BIRTHDATE" type="date" class="form-control" value="'.$animal['BirthDate'].'">
                    </dd>
                    <br>
                    <dt>Omgeving</dt>
                    <dd>
                        <select name="ENVIRONMENTNAME" type="text" class="form-control" value="'.$animal['EnvironmentName'].'">
                            <option value="'.$animal['EnvironmentName'].'">'.$animal['EnvironmentName'].'</option>';
         ...
         echo '         </select>
                    ...
                    <dt>Gebied</dt>
                    <dd>
                        <select name="AREANAME" type="text" class="form-control" value="'.$animal['AreaName'].'">
                            <option value="'.$animal['AreaName'].'">'.$animal['AreaName'].'</option>';
        ...
        echo '          </select>
                    ...
                    <dd>
                        <input name="ENCLOSUREID" type="number" class="form-control" value="'.$animal['EnclosureID'].'" maxlength="10" max="2147483646" >
                    </dd>
                    <br>
                    <br>
                    <dt>Beschrijving </dt>
       ...
       <div class="col-lg-6">
           ...
           <br>';
            if(isset($animal['Image'])) {
                echo '<img src="'. isLocal() .'/pictures/' . $animal['Image'] . '" width="300" height="300"><br><br>';
            }
...
?>
    ...
    <br>
    <br>
    <h2>Uitwisselingsgeschiedenis</h2><br>
        ...
        foreach($getExchangeHistorys as $getExchangeHistory) {
            echo '
                <tr>
                    ...
                    <td>
                        <a href="?page=alterExchangehistory&animalid='.$animalID,'&senddate=', $getExchangeHistory["SendDate"].'">
                        <button type="button" class="btn btn-default">Aanpassen</button></a>
                    </td>
                </tr>';
        } echo '</table>';
    } echo'
        <a href="?page=addExchangeHistory&animalid='.$animalID.'">
            <button type="button" class="btn btn-default">Toevoegen</button>
        </a>';?>